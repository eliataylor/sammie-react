        ...
        return (
          <div id="santaCaseStudy" className="mt-3">
            ...
            <div className="container-fluid bg-info text-white mt-5" >
              <div className="row">
                <div className="p-5 mt-4 mb-4" style={{minHeight:'25vh', justifyContent: 'center', display: 'flex', flexDirection: 'column'}}>
                  <h2>Final Designs</h2>
            ...
            <div className="row text-center mt-4 mb-4">
              ...
              <div className="col-6 mb-5">
                ...
                <img height='300' className="img-fluid" src='/assets/santa/screenshot-1-before.png' />
              </div>
              <div className="col-6 mb-5">
                <h6>Sign Up Screen (After)</h6>
                <img height='300' className="img-fluid" src='/assets/santa/screenshot-1-after.png' />
              </div>
              <div className="col-6 mb-5">
                <h6>Role Selection Screen (Before)</h6>
                <img height='300' className="img-fluid" src='/assets/santa/screenshot-2-before.png' />
              </div>
              <div className="col-6 mb-5">
                <h6>Role Selection Screen (After)</h6>
                <img height='300' className="img-fluid" src='/assets/santa/screenshot-2-after.png' />
              </div>
              <div className="col-6 mb-5">
                <h6>Wishes Locator Screen (Before)</h6>
                <img height='300' className="img-fluid" src='/assets/santa/screenshot-3-before.png' />
              </div>
              <div className="col-6 mb-5">
                <h6>Wishes Locator Screen (After)</h6>
                <img height='300' className="img-fluid" src='/assets/santa/screenshot-3-after.png' />
              </div>
            </div>
            </div>
