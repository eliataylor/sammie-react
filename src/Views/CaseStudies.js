    ...
    render() {
        return (
          <div className="container">
            ...
            <div className="jumbotron d-flex flex-column" style={{backgroundImage:'url(/assets/santa-photo.png)'}}>
              <div className="flex-grow-1"></div>
              <div>
                <h3>Santa App</h3>
                <p className="fontLight mb-4 mt-4">Help fulfill wishes for the<br /> homeless in your community</p>
                <Link to="/case-studies/santa" style={{fontSize:15, fontWeight:600, padding:'7px 70px'}} className="btn btn-outline-light btn-lg">VIEW CASE STUDY</Link>
              </div>
            </div>
